...
function getMeal(dietaryPreference, goal, cuisine) {
    var day = getMealDay(); // Get the current meal rotation day (0, 1, or 2)

    // Check if the user has manually chosen a whole meal set on the feedback page (legacy support)
